...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zbb8uw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zbb8uw.containers.anotherwebservice.com/
...
```
git clone git@github.com:ddomino007/container-zbb8uw.git
cd container-zbb8uw
```
...
```
docker attach container-zbb8uw
```
